...
def main():
    ...
    # Reference audio
    ref_audio_path = os.path.join(project_root, "assets", "Leejamsample.mp3")
    ref_text = "유연의 지원과 도움의 힘입어 성장한 우리 대한민국은 이제 민주주의 회복의 경험과 역사를 아낌없이 나누는 선도국가로서의 역할을 마다하지 않겠습니다. 각국의 끊임없는 노력에도 불구하고 세계 평화와 안전 유지라는 80년 전 국제사회의 결의와 염원은 아직 끝나지 않은 우리 모두의 과제입니다."
